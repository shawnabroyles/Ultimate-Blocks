				...
				>
					<div
						...
						style={{
							...
							borderWidth: !onControlBrSize
								? `${columnBorderTop}px ${columnBorderRight}px ${columnBorderBottom}px ${columnBorderLeft}px`
								: `${columnBorderSize}px`,
							borderRadius: !onControlBrRadius
								? `${columnBrTopRadius}px ${columnBrRightRadius}px ${columnBrBottomRadius}px ${columnBrLeftRadius}px`
								: `${columnBorderRadius}px`
						}}
					>
